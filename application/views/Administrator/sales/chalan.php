            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 text-right">
                        ...
                        <strong>Challan No:</strong> {{ sales.SaleMaster_InvoiceNo }}<br>
                        <strong>Wo / Po No:</strong> {{ sales.wo_po_no }} <br> 
            ...
            async print() {
                let reportContent = `
					<div class="container">
                        ...
                        <div class="row" style="position:fixed;bottom:15px; width:95%; margin-bottom:5px;padding-bottom:6px;">
                            <div class="col-xs-4">
