	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" id="invoiceNo" class="form-control" v-model="sales.invoiceNo" />
				</div> 
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> WO / PO No </label>
				<div class="col-sm-2">
					<input type="text" class="form-control" v-model="sales.wo_po_no" placeholder="WO / PO No">
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<!--	<label class="col-sm-3 control-label no-padding-right">Free.prod</label>-->
								<!--	<div v-if="item_type == 'product'" class="col-sm-9">-->
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:8%;color:#000;">Free Product</th>
