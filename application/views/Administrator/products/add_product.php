		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix" >
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/size" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
			...
			<div class="col-md-6">
				...
				<!--	<label class="control-label col-md-4">Pack Size:</label>-->
				<!--	<div class="col-md-7">-->
				<!--		<input type="checkbox" v-model="product.brand_name">-->
				<!--	</div>-->
				<!--</div>-->
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Pack Size', field: 'brand_name', align: 'center' },
