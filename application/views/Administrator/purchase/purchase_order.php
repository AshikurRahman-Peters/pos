				...
				<div class="row">
					...
					<div class="col-sm-6">
						<form v-on:submit.prevent="addToCart">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right">pur.Cash. Rate </label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> pur.Pic. Rate </label>
								<div class="col-sm-8">
									<input type="text" id="purchaseRate" name="purchaseRate" class="form-control" placeholder="Pur. Rate" v-model="selectedProduct.Product_Purchase_pic_Rate" v-on:input="productTotal" autocomplete="off" />
								</div>
							</div>
							<tr>
								<td>
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right">Free Product</label>
										<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Sell.cash. Price </label>
								<div class="col-sm-8">
									<input type="text" id="sellingPrice" name="sellingPrice" class="form-control" v-model="selectedProduct.Product_SellingPrice" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Sell.pic. Price </label>
								<div class="col-sm-8">
									<input type="text" id="sellingPrice" name="sellingPrice" class="form-control" v-model="selectedProduct.Product_SellingpicPrice" />
								</div>
							</div>
			...
			<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
				<thead>
					<tr>
						...
						<th style="width:5%;color:#000;">Free Product</th>
					...
					<div class="col-sm-12">
						<div class="table-responsive">
							<table style="color:#000;margin-bottom: 0px;">
								...
								<!--	<td>-->
								<!--		<div class="form-group">-->
								<!--			<label class="col-sm-12 control-label no-padding-right">Free Product</label>-->
								<!--			<div class="col-sm-12">-->
...
<script>
	...
	new Vue({
		...
		data() {
			return {
				...
				selectedProduct: {
					...
					Product_Purchase_pic_Rate:'',
					Product_SellingPrice: 0.00,
					Product_SellingpicPrice: 0.00,
					total: '',
					discount: 0
				},
				cart: [],
		...
		methods: {
			...
			onChangeProduct() {
                this.Product_SellingpicPrice = this.Product_SellingpicPrice / 24;
			...
			productTotal() {
				...
				this.selectedProduct.total = price;
			},
			addToCart() {
			...
			calculateTotal() {
				...
				this.purchase.total = (parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) + parseFloat(this.purchase.freight));
