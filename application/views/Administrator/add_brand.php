...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pack Size Name  </label>
			<label class="col-sm-1 control-label no-padding-right">:</label>
			<div class="col-sm-8">
				<input type="text" id="brandname" name="brandname" placeholder="Pack Size Name" value="<?php echo set_value('brandname'); ?>" class="col-xs-10 col-sm-4" />
				<span id="msg"></span>
    ...
    function deleted(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                window.location.href='<?php echo base_url(); ?>Administrator/page/add_size';
            }
        });
		};
    }
