const salesInvoice = Vue.component('sales-invoice', {
    ...
    methods:{
        ...
        async print() {
            ...
            if (this.companyProfile.print_type == '3') {
                ...
                `);
            } else if (this.companyProfile.print_type == '2') {
                printWindow.document.write(`
                    <!DOCTYPE html>
                    <html lang="en">
                    <head>
                    ...
                    <div class="container"  style="display:${this.companyProfile.Invoice_Type != 1 ? 'block' : 'none'}" >
                        <div> 
                            <div>
                                <img src="/assets/images/invoice/h${this.companyProfile.Invoice_Type}.png" style="width: 100%;" />
                            </div>
                        </div>
                    </div>

                        <div class="row" style="display:${this.companyProfile.Invoice_Type == 1 ? 'block' : 'none'}>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="container"  style="display:${this.companyProfile.Invoice_Type != 1 ? 'block' : 'none'}" >
                            <div> 
                                <div>
                                    <img src="/assets/images/invoice/h${this.companyProfile.Invoice_Type}.png" style="width: 100%; margin-right:-10px !important;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container" style="display:${this.companyProfile.Invoice_Type == 1 ? 'block' : 'none'}">
                            <div class="row">
                                <div class="col-xs-2"><img src="/uploads/company_profile_org/${this.companyProfile.Company_Logo_org}" alt="Logo" style="height:80px;" /></div>
                                <div class="col-xs-10" style="padding-top:20px;">
                                    <strong style="font-size:18px;">${this.companyProfile.Company_Name}</strong><br>
                                    ${this.companyProfile.Repot_Heading}
                                </div>
                        ...
                        <div class="container" style="z-index:222">
                            <div class="row">
                                <div class="col-xs-12">
                                    ${invoiceContent}
                                </div>
                    ...
                    <div class="container">
                        <div class="invouce_redimate"> 
                            <div id="DivContent" style="display:${this.companyProfile.Invoice_Type != 1 ? 'block' : 'none'};" >
                            <img src="/assets/images/invoice/f${this.companyProfile.Invoice_Type}.png" alt="Logo" style="width: 100%;position:fixed;bottom: 0 !important; margin-left:-10px" />
                        </div>
                        </div>
                    </div>
                        <div class="container" style="display:${this.companyProfile.Invoice_Type == 1 ? 'block' : 'none'}; position:fixed; margin-top:30px; bottom:15px;width:100%;">
